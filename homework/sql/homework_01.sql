/* ЗАДАНИЕ
   ...
   2) Выполните любые 5 запросов с фильтрацией командой WHERE и чтоб были AND OR NOT,
   3) и 2 запроса с обработкой параметра NULL (IS NULL, IS NOT NULL).
...
CREATE DATABASE agro_crm_db;                    -- Отраслевая CRM "Агропромышленный комплекс"
